...
weight_reader = WeightReader('D:/Projects/FaceMaskClassification/data/yolov3-wider_16000.weights')
weight_reader.load_weights(model)
model.save('D:/Projects/FaceMaskClassification/data/yolo_face_model.h5')
